...
class BinaryTree:
    ...
    def add(self, new_node: Node):
        ...
        while current_node:
            if current_node.value == new_node.value:
                raise ValueError("Node already exists. No Duplication allowed")
    ...
    def find_parent(self, value: int) -> Node:
        ...
        current_node = self.head
        while current_node:
            if (current_node.right and current_node.right.value == value) or \
                    (current_node.left and current_node.left.value == value):
                return current_node
            elif value > current_node.value:
                current_node = current_node.right
            elif value < current_node.value:
